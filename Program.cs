...
repo.TestRepo(parameters, "School_GetList2", true);
repo.TestRepo(parameters, "School_GetList3", true);
repo.TestRepo(parameters, "School_GetList4", true);
repo.TestRepo(parameters, "School_GetList5", true);
